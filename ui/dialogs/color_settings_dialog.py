...
class ColorSettingsDialog(FloatingPanel):
    ...
    def init_ui(self):
        ...
        self.node_selected_btn.clicked.connect(
            lambda: self.choose_color("node_selected", colors["node_selected_color"])
        )
        ...
        self.output_anchor_btn.clicked.connect(
            lambda: self.choose_color("output_anchor", colors["output_anchor_color"])
        )
        ...
        self.toast_success_btn.clicked.connect(
            lambda: self.choose_color("toast_success", colors["toast_success_color"])
        )
        ...
        self.toast_warning_btn.clicked.connect(
            lambda: self.choose_color("toast_warning", colors["toast_warning_color"])
        )
        ...
        self.dock_border_active_btn.setStyleSheet(
            f"background-color: {colors['dock_floating_border_color']}; min-height: 30px;"
        )
        self.dock_border_active_btn.clicked.connect(
            lambda: self.choose_color("dock_active", colors["dock_floating_border_color"])
        )
        ...
        self.dock_border_inactive_btn.setStyleSheet(
            f"background-color: {colors['dock_floating_border_inactive']}; min-height: 30px;"
        )
        self.dock_border_inactive_btn.clicked.connect(
            lambda: self.choose_color("dock_inactive", colors["dock_floating_border_inactive"])
        )
    ...
    def _get_current_colors(self):
        ...
        if canvas:
            return {
                ...
                "dock_floating_border_color": getattr(
                    canvas, "dock_floating_border_color", default_colors["dock_floating_border_color"]
                ),
                "dock_floating_border_inactive": getattr(
                    canvas, "dock_floating_border_inactive", default_colors["dock_floating_border_inactive"]
                ),
            }
    ...
    def apply_preset_theme(self, theme_name):
        ...
        if theme:
            ...
            self.dock_border_active_btn.setStyleSheet(
                f"background-color: {theme['dock_floating_border_color']}; min-height: 30px;"
            )
            self.dock_border_inactive_btn.setStyleSheet(
                f"background-color: {theme['dock_floating_border_inactive']}; min-height: 30px;"
            )
    ...
    def collect_settings(self):
        ...
        return {
            ...
            "dock_floating_border_inactive": getattr(
                self, "temp_dock_inactive_color", colors["dock_floating_border_inactive"]
            ),
        }
