...
生成方式: python -m ui.core.translation_keys --regenerate
...
# ═══════════════════════════════════════════════════════════════════
# 重新生成此文件 (python -m ui.core.translation_keys --regenerate)
# ═══════════════════════════════════════════════════════════════════
def _regenerate():
    ...
    lines.append('生成方式: python -m ui.core.translation_keys --regenerate')
    lines.append('')
    lines.append('用法:')
    lines.append('    from ui.core.translation_keys import TK')
