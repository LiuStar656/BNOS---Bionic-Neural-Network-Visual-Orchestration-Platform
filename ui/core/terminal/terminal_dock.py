...
from PySide6.QtWidgets import QComboBox, QHBoxLayout, QTabWidget, QToolButton, QVBoxLayout, QWidget
...
class TerminalDock(BnosDock):
    ...
    def _setup_toolbar(self):
        ...
        self.terminal_type_combo.addItems(
            [t("k_terminal_type_powershell"), t("k_terminal_type_cmd"), t("k_terminal_type_bash")]
        )
