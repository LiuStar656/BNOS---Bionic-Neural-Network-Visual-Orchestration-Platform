...
class CanvasHost(QMainWindow):
    ...
    def _create_canvas_dock(self, name=None, project_path=None):
        ...
        # 初始化画布独立数据
        canvas_data = {"nodes_data": {}, "connections": [], "project_path": project_path}
    ...
    def _on_focus_changed(self, old, new):
        ...
        while current_widget:
            # 检查是否是NodeCanvas或其子类
            if hasattr(current_widget, "__class__") and "NodeCanvas" in [
                cls.__name__ for cls in current_widget.__class__.__mro__
            ]:
    ...
    def _connect_terminal_signals(self):
        ...
        if hasattr(self, "_terminal_dock") and self._terminal_dock:
            self._terminal_dock.visibility_changed.connect(self._on_terminal_visibility_changed)
    ...
    def _on_terminal_visibility_changed(self, visible: bool):
        ...
        logger.info(
            "🔔 _on_terminal_visibility_changed: visible=%s, is_closing=%s",
            visible,
