...
from PySide6.QtWidgets import QDockWidget, QHBoxLayout, QLabel, QSizeGrip, QToolButton, QVBoxLayout, QWidget

from ui.core.dock.dock_position_manager import DockPositionManager  # DockDoubleClickHandler 已禁用
...
def set_dock_floating_colors(active_color, inactive_color):
    ...
    from ui.core.dock.dock_manager import set_dock_floating_colors as set_mgr_colors
