> ⚠️ **ARCHIVED** — This is the v1 README, superseded by the [current README](../../README.md) as of 2026-07-13. Kept for historical reference only.
...
📘 **[BNOS Platform Technical Documentation →](docs/reference/TECHNICAL_DOCUMENTATION.md)** — Architecture design, core component details, IPC communication, lifecycle management, and complete project line count statistics
