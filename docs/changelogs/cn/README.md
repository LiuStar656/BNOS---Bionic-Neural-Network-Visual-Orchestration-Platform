...
---
<details open>
<summary><strong>【2026-07-13】V2.0.28 - 复合节点右键菜单优化、输入锚点独占检测与折叠DAG拓扑更新修复</strong></summary>

[查看完整更新](./2026-07-13/README.md) | [01_右键菜单与锚点检测](./2026-07-13/01_复合节点右键菜单优化与输入锚点独占检测.md) | [02_DAG拓扑修复](./2026-07-13/02_复合节点折叠DAG拓扑更新修复.md)

**主要更新：**
- 复合节点右键菜单优化：启动/停止互斥显示，解耦移至最低层并灰显，展开/折叠增加运行状态双重校验
- 输入锚点独占检测：一个输入锚点只能接受一条连线，拒绝多源接入（`target_anchor.edges` 检测），保护数据一致性
- 折叠 DAG 拓扑修复：根因为 `composite.json` edges 从未更新，修复后展开→重新连线→折叠→新拓扑正确生效
